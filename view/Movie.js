...
export default class Movie extends Component {
    ...
    _navigate(pageNum:String, title:String) {
        this.props.navigator.push({
            ...
            params: {
                pageNum: pageNum,
                title: title,
                movieNum: this.state.select
            }
        });
    }

    getData() {
        this.repositor1.getMovie(this.state.select, this.state.pageNum)
            .then((responseData) => {
    ...
    _rendRow1(dataSource) {
        ...
        return (
            <TouchableHighlight underlayColor='#c8c7cc' onPress={this._navigate.bind(this,pageNum,dataSource.title)}>
